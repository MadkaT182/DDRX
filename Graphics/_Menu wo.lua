...
t[#t+1] = Def.ActorFrame {
	...
	PlayCommand=function(self)
		...
		SOUND:PlayAnnouncer( "Menu workout" )
		end;
	end;
	...
	LoadActor( "_MenuArt/thumb/workout"..lang )..{
	...
	LoadActor( "_MenuArt/dialog/workout"..lang )..{
	OnCommand=cmd(stoptweening;x,138;y,188;diffusealpha,0;sleep,0.433;linear,0.05;diffusealpha,1);
	};

	LoadActor("_MenuArt/menu/bg/wo")..{
	InitCommand=cmd(addx,284;addy,-86;rotationz,-1.96;glowshift;effectperiod,0.25;effectcolor1,color("#d07c0000");effectcolor2,color("#fe990188"));
	};

	LoadActor("_MenuArt/menu/text/wo")..{
	InitCommand=cmd(addx,284;addy,-86;rotationz,-1.96);
	};
