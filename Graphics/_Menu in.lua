...
t[#t+1] = Def.ActorFrame {
	...
	PlayCommand=function(self)
		...
		SOUND:PlayAnnouncer( "Menu information" )
		end;
	end;
	...
	LoadActor( "_MenuArt/thumb/information"..lang )..{
	...
	LoadActor( "_MenuArt/dialog/information"..lang )..{
	OnCommand=cmd(stoptweening;x,138;y,188;diffusealpha,0;sleep,0.433;linear,0.05;diffusealpha,1);
	};

	LoadActor("_MenuArt/menu/bg/in")..{
	InitCommand=cmd(addx,285;addy,110;rotationz,-1.93;glowshift;effectperiod,0.25;effectcolor1,color("#d07c0000");effectcolor2,color("#fe990188"));
	};

	LoadActor("_MenuArt/menu/text/in")..{
	InitCommand=cmd(addx,285;addy,110;rotationz,-1.93);
	};
