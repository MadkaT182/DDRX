...
t[#t+1] = Def.ActorFrame {
	...
	PlayCommand=function(self)
		...
		SOUND:PlayAnnouncer( "Menu streetmaster" )
		end;
	end;
	...
	LoadActor( "_MenuArt/thumb/streetmaster"..lang )..{
	...
	LoadActor( "_MenuArt/dialog/streetmaster"..lang )..{
	OnCommand=cmd(stoptweening;x,138;y,188;diffusealpha,0;sleep,0.433;linear,0.05;diffusealpha,1);
	};

	LoadActor("_MenuArt/menu/bg/sm")..{
	InitCommand=cmd(addx,282;addy,-114;rotationz,1.84;glowshift;effectperiod,0.25;effectcolor1,color("#d07c0000");effectcolor2,color("#fe990188"));
	};

	LoadActor("_MenuArt/menu/text/sm")..{
	InitCommand=cmd(addx,282;addy,-114;rotationz,1.84);
	};
