...
t[#t+1] = Def.ActorFrame {
	...
	PlayCommand=function(self)
		...
		SOUND:PlayAnnouncer( "Menu party" )
		end;
	end;
	...
	LoadActor( "_MenuArt/thumb/party"..lang )..{
	...
	LoadActor( "_MenuArt/dialog/party"..lang )..{
	OnCommand=cmd(stoptweening;x,138;y,188;diffusealpha,0;sleep,0.433;linear,0.05;diffusealpha,1);
	};

	LoadActor("_MenuArt/menu/bg/pz")..{
	InitCommand=cmd(addx,286;rotationz,-3.01;glowshift;effectperiod,0.25;effectcolor1,color("#d07c0000");effectcolor2,color("#fe990188"));
	};

	LoadActor("_MenuArt/menu/text/pz")..{
	InitCommand=cmd(addx,286;rotationz,-3.01);
	};
