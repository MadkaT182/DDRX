...
t[#t+1] = Def.ActorFrame {
	...
	PlayCommand=function(self)
		...
		SOUND:PlayAnnouncer( "Menu training" )
		end;
	end;
	...
	LoadActor( "_MenuArt/thumb/training"..lang )..{
	...
	LoadActor( "_MenuArt/dialog/training"..lang )..{
	OnCommand=cmd(stoptweening;x,138;y,188;diffusealpha,0;sleep,0.433;linear,0.05;diffusealpha,1);
	};

	LoadActor("_MenuArt/menu/bg/tr")..{
	InitCommand=cmd(addx,283;addy,-58;rotationz,1.97;glowshift;effectperiod,0.25;effectcolor1,color("#d07c0000");effectcolor2,color("#fe990188"));
	};

	LoadActor("_MenuArt/menu/text/tr")..{
	InitCommand=cmd(addx,283;addy,-58;rotationz,1.97);
	};
