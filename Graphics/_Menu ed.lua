...
t[#t+1] = Def.ActorFrame {
	...
	LoadActor( "_MenuArt/thumb/edit"..lang )..{
	...
	LoadActor( "_MenuArt/dialog/edit"..lang )..{
	OnCommand=cmd(stoptweening;x,138;y,188;diffusealpha,0;sleep,0.433;linear,0.05;diffusealpha,1);
	};

	LoadActor("_MenuArt/menu/bg/ed")..{
	InitCommand=cmd(addx,286;addy,-30;rotationz,-1.91;glowshift;effectperiod,0.25;effectcolor1,color("#d07c0000");effectcolor2,color("#fe990188"));
	};

	LoadActor("_MenuArt/menu/text/ed")..{
	InitCommand=cmd(addx,286;addy,-30;rotationz,-1.91);
	};
