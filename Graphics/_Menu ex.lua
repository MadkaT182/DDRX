...
t[#t+1] = Def.ActorFrame {
	...
	LoadActor("_MenuArt/menu/bg/ex")..{
	InitCommand=cmd(addx,285;addy,138;rotationz,1.84;glowshift;effectperiod,0.25;effectcolor1,color("#d07c0000");effectcolor2,color("#fe990188"));
	};

	LoadActor("_MenuArt/menu/text/ex")..{
	InitCommand=cmd(addx,285;addy,138;rotationz,1.84);
	};
};
