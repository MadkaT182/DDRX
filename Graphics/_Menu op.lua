...
t[#t+1] = Def.ActorFrame {
	...
	PlayCommand=function(self)
		...
		SOUND:PlayAnnouncer( "Menu options" )
		end;
	end;
	...
	LoadActor("_MenuArt/menu/bg/op")..{
	InitCommand=cmd(addx,284;addy,55;rotationz,1.35;glowshift;effectperiod,0.25;effectcolor1,color("#d07c0000");effectcolor2,color("#fe990188"));
	};

	LoadActor("_MenuArt/menu/text/op")..{
	InitCommand=cmd(addx,284;addy,55;rotationz,1.35);
	};
