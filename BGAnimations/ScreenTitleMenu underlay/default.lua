return Def.ActorFrame {
	...
	LoadActor( "../ScreenLogo background/ddrx_light1.png" )..{
		...
		LaterCommand=cmd(sleep,14;queuecommand,"Animate";queuecommand,"Later");
	};
	...
	LoadActor( "../konami_copyright" )..{
		OnCommand=cmd(queuecommand,"Logo");
		LogoCommand=cmd(x,SCREEN_CENTER_X;y,SCREEN_CENTER_Y+215;diffusealpha,0;sleep,0.916;linear,0.4;diffusealpha,1);
	};
	...
	LoadActor( "../ScreenLogo background/D1.png" )..{
		...
		LaterCommand=cmd(sleep,18.6;queuecommand,"D1";queuecommand,"Later");
	};
