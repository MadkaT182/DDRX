...
t[#t+1] = Def.ActorFrame {
	...
	LoadActor( "Newrecord" )..{
		OnCommand=cmd(x,SCREEN_CENTER_X-230;y,SCREEN_CENTER_Y+103;glowblink;effectperiod,0.258;effectcolor1,color("1,1,1,0");effectcolor2,color("1,1,1,0.25");diffusealpha,0;zoomy,0;draworder,1;sleep,2.416;linear,0.15;diffusealpha,1;zoomy,1);
...
t[#t+1] = Def.ActorFrame {
	...
	LoadActor( "Newrecord" )..{
		OnCommand=cmd(x,SCREEN_CENTER_X+232;y,SCREEN_CENTER_Y+103;glowblink;effectperiod,0.258;effectcolor1,color("1,1,1,0");effectcolor2,color("1,1,1,0.25");diffusealpha,0;zoomy,0;draworder,1;sleep,2.416;linear,0.15;diffusealpha,1;zoomy,1);
		OffCommand=cmd(linear,0.3;zoomy,0);
	};
		LoadActor( "RecSound" )..{
		OnCommand=cmd(play);
