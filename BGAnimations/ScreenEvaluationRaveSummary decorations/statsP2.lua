...
t[#t+1] = LoadFont("ScreenEvaluation judge")..{
	InitCommand=cmd(player,PLAYER_2;y,SCREEN_CENTER_Y-227;horizalign,right);
...
--Perfect--
t[#t+1] = LoadFont("ScreenEvaluation judge")..{
	InitCommand=cmd(player,PLAYER_2;y,SCREEN_CENTER_Y-208;horizalign,right);
	OnCommand=function(self)
...
--Great--
t[#t+1] = LoadFont("ScreenEvaluation judge")..{
	InitCommand=cmd(player,PLAYER_2;y,SCREEN_CENTER_Y-189;horizalign,right);
	OnCommand=function(self)
		self:settextf(Great);
	end;
};
--Good--
t[#t+1] = LoadFont("ScreenEvaluation judge")..{
	InitCommand=cmd(player,PLAYER_2;y,SCREEN_CENTER_Y-170;horizalign,right);
	OnCommand=function(self)
		self:settextf(Good);
	end;
};
--Almost--
t[#t+1] = LoadFont("ScreenEvaluation judge")..{
	InitCommand=cmd(player,PLAYER_2;y,SCREEN_CENTER_Y-151;horizalign,right);
	OnCommand=function(self)
...
--Boo--
t[#t+1] = LoadFont("ScreenEvaluation judge")..{
	InitCommand=cmd(player,PLAYER_2;y,SCREEN_CENTER_Y-132;horizalign,right);
	OnCommand=function(self)
		self:settextf(Boo);
	end;
};
--Ok--
t[#t+1] = LoadFont("ScreenEvaluation judge")..{
	InitCommand=cmd(player,PLAYER_2;y,SCREEN_CENTER_Y-113;horizalign,right);
	OnCommand=function(self)
		self:settextf(Ok);
	end;
};
...
--Max Combo--
t[#t+1] = LoadFont("ScreenEvaluation judge")..{
	InitCommand=cmd(player,PLAYER_2;y,SCREEN_CENTER_Y-75;horizalign,right);
	OnCommand=function(self)
		self:settextf(Combo);
	end;
};
