...
LoadActor("../door1")..{
	OnCommand=cmd(x,SCREEN_CENTER_X-SCREEN_WIDTH/4;y,SCREEN_CENTER_Y;addx,-SCREEN_WIDTH/2;sleep,0;sleep,.316;linear,.2;addx,SCREEN_WIDTH/2;sleep,1.167;sleep,3.383;linear,.2;addx,-SCREEN_WIDTH/2);
};
LoadActor("../door2")..{
	OnCommand=cmd(x,SCREEN_CENTER_X+SCREEN_WIDTH/4;y,SCREEN_CENTER_Y;addx,SCREEN_WIDTH/2;sleep,0;sleep,.316;linear,.2;addx,-SCREEN_WIDTH/2;sleep,1.167;sleep,3.383;linear,.2;addx,SCREEN_WIDTH/2);
};
