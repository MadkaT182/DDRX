return Def.ActorFrame {
	...
	LoadActor("../_SortDisplay")..{
		...
		OffCommand=cmd(linear,.133;addy,-58);
	};
	LoadActor("../timerBG")..{
		OnCommand=cmd(x,SCREEN_CENTER_X+266;y,SCREEN_CENTER_Y-213);
	};
	LoadActor("headbg")..{
		OnCommand=cmd(x,SCREEN_CENTER_X-180;addy,35;zoom,0;diffusealpha,0;sleep,.516000;sleep,.033;linear,.1;diffusealpha,1;zoom,1.05;linear,.066;zoom,1);
